...
def get_sam2_model_cfg_and_ckpt_path(model_type='large'):
    ...
    config_map = {
        'tiny':      ("configs/sam2.1/sam2.1_hiera_t.yaml", "/mnt/data/wangzijian/FSOD-VFM-Public/checkpoints/sam2.1_hiera_tiny.pt"),
        'small':     ("configs/sam2.1/sam2.1_hiera_s.yaml", "/mnt/data/wangzijian/FSOD-VFM-Public/checkpoints/sam2.1_hiera_small.pt"),
        'base_plus': ("configs/sam2.1/sam2.1_hiera_b+.yaml", "/mnt/data/wangzijian/FSOD-VFM-Public/checkpoints/sam2.1_hiera_base_plus.pt"),
        'large':     ("configs/sam2.1/sam2.1_hiera_l.yaml", "/mnt/data/wangzijian/FSOD-VFM-Public/checkpoints/sam2.1_hiera_large.pt"),
    }
